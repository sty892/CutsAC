...
public class BukkitPermissionRegistrationManager implements PermissionRegistrationManager {
     ...
     * like "custac.exempt.checkname") that are generated at runtime. Most other static permissions
     * (e.g., "custac.exempt", "custac.alerts.enable-on-join") are registered with their defaults
     ...
     *
     * @param name         The permission node to register (e.g., "custac.exempt.checkname").
