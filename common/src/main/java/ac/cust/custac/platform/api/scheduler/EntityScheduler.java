...
package ac.cust.custac.platform.api.scheduler;
...
public interface EntityScheduler {
     ...
     */
    void execute(@NotNull CustACEntity entity, @NotNull GrimPlugin plugin, @NotNull Runnable run, @Nullable Runnable retired, long delay);
     ...
     */
    TaskHandle run(@NotNull CustACEntity entity, @NotNull GrimPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runDelayed(@NotNull CustACEntity entity, @NotNull GrimPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired, long delayTicks);
     ...
     * @return {@link TaskHandle} instance representing a wrapped task
     */
    TaskHandle runAtFixedRate(@NotNull CustACEntity entity, @NotNull GrimPlugin plugin, @NotNull Runnable task, @Nullable Runnable retired, long initialDelayTicks, long periodTicks);
}
