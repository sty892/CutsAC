...
public interface PermissionRegistrationManager {
     ...
     * dynamic permissions (e.g., check-specific permissions like "custac.exempt.checkname")
     * are available for autocomplete before CustAC attempts to use them. This is
     ...
     *
     * @param name         The permission node to register (e.g., "custac.exempt").
