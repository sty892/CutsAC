...
import ac.cust.custac.checks.impl.aim.AimDuplicateLook;
import ac.cust.custac.checks.impl.aim.AimModulo360;
import ac.cust.custac.checks.impl.aim.processor.AimProcessor;
import ac.cust.custac.checks.impl.badpackets.*;
import ac.cust.custac.checks.impl.breaking.*;
import ac.cust.custac.checks.impl.chat.ChatA;
import ac.cust.custac.checks.impl.chat.ChatB;
import ac.cust.custac.checks.impl.chat.ChatC;
import ac.cust.custac.checks.impl.chat.ChatD;
import ac.cust.custac.checks.impl.combat.*;
import ac.cust.custac.checks.impl.crash.*;
import ac.cust.custac.checks.impl.elytra.*;
import ac.cust.custac.checks.impl.exploit.ExploitA;
import ac.cust.custac.checks.impl.exploit.ExploitB;
import ac.cust.custac.checks.impl.groundspoof.NoFall;
import ac.cust.custac.checks.impl.misc.ClientBrand;
import ac.cust.custac.checks.impl.misc.GhostBlockMitigation;
import ac.cust.custac.checks.impl.misc.Post;
import ac.cust.custac.checks.impl.misc.TransactionOrder;
import ac.cust.custac.checks.impl.movement.NoSlow;
import ac.cust.custac.checks.impl.movement.PredictionRunner;
import ac.cust.custac.checks.impl.movement.SetbackBlocker;
import ac.cust.custac.checks.impl.movement.VehiclePredictionRunner;
import ac.cust.custac.checks.impl.multiactions.*;
import ac.cust.custac.checks.impl.packetorder.*;
import ac.cust.custac.checks.impl.prediction.DebugHandler;
import ac.cust.custac.checks.impl.prediction.GroundSpoof;
import ac.cust.custac.checks.impl.prediction.OffsetHandler;
import ac.cust.custac.checks.impl.prediction.Phase;
import ac.cust.custac.checks.impl.scaffolding.*;
import ac.cust.custac.checks.impl.sprint.*;
import ac.cust.custac.checks.impl.timer.*;
import ac.cust.custac.checks.impl.vehicle.*;
import ac.cust.custac.checks.impl.velocity.ExplosionHandler;
import ac.cust.custac.checks.impl.velocity.KnockbackHandler;
import ac.cust.custac.checks.type.*;
import ac.cust.custac.events.packets.PacketChangeGameState;
import ac.cust.custac.events.packets.PacketEntityReplication;
import ac.cust.custac.events.packets.PacketPlayerAbilities;
...
import ac.cust.custac.predictionengine.GhostBlockDetector;
import ac.cust.custac.predictionengine.SneakingEstimator;
import ac.cust.custac.utils.anticheat.update.*;
import ac.cust.custac.utils.latency.CompensatedCameraEntity;
import ac.cust.custac.utils.latency.CompensatedCooldown;
import ac.cust.custac.utils.latency.CompensatedFireworks;
import ac.cust.custac.utils.latency.CompensatedInventory;
import ac.cust.custac.utils.team.TeamHandler;
...
public class CheckManager {
    ...
    public CheckManager(CustACPlayer player) {
    ...
    private void init() {
        ...
        for (final AbstractCheck check : allChecks.values()) {
            ...
            for (String permissionName : permissions) {
                permissionName += id;
                CustACAPI.INSTANCE.getPermissionManager().registerPermission(permissionName, PermissionDefaultValue.FALSE);
            }
        }
    }
}
