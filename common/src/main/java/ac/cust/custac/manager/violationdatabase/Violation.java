...
public record Violation(String server, UUID uuid, String checkName, String verbose, int vl,
                        long createdAt, String custacVersion, String clientBrand, String clientVersion, String serverVersion) {
    ...
    public static List<Violation> fromResultSet(ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            String custacVersion = resultSet.getString(DatabaseConstants.GRIM_VERSIONS_STRING_COLUMN);
            ...
            violations.add(new Violation(server, uuid, checkName, verbose, vl, createdAt, custacVersion, clientBrand, clientVersion, serverVersion));
        }
        return violations;
    }
}
