...
public interface DatabaseConstants {
    String SERVERS_TABLE = "custac_history_servers";
    String CHECK_NAMES_TABLE = "custac_history_check_names";
    String GRIM_VERSIONS_TABLE = "custac_history_versions";
    String CLIENT_BRANDS_TABLE = "custac_history_client_brands";
    String CLIENT_VERSIONS_TABLE = "custac_history_client_versions";
    String SERVER_VERSIONS_TABLE = "custac_history_server_versions";
    String VIOLATIONS_TABLE = "custac_history_violations";

    String SERVERS_STRING_COLUMN = "server_name";
    String CHECK_NAMES_STRING_COLUMN = "check_name_string";
    String GRIM_VERSIONS_STRING_COLUMN = "custac_version_string";
    ...
    String VIOLATIONS_GRIM_VERSION_ID_COLUMN = "custac_version_id";
