package ac.cust.custac.manager.player.handlers;
...
import ac.cust.custac.platform.api.world.PlatformChunk;
...
public record DefaultResyncHandler(CustACPlayer player) implements ResyncHandler {

    private static void resyncPositions(CustACPlayer player, int minBlockX, int mY, int minBlockZ, int maxBlockX, int mxY, int maxBlockZ) {
        ...
        CustACAPI.INSTANCE.getScheduler().getRegionScheduler().execute(CustACAPI.INSTANCE.getGrimPlugin(), world,
    ...
    private static void resyncPosition(CustACPlayer player, int x, int y, int z, int sequence) {
        if (player.platformPlayer == null) return;
        ...
        CustACAPI.INSTANCE.getScheduler().getRegionScheduler().execute(CustACAPI.INSTANCE.getGrimPlugin(), world, chunkX, chunkZ, () -> {
