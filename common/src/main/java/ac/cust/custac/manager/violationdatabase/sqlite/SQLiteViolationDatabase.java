package ac.cust.custac.manager.violationdatabase.sqlite;
...
public class SQLiteViolationDatabase implements ViolationDatabase {
    ...
    public void connect() throws SQLException {
        try (Connection connection = getConnection()) {
            ...
            // 3. Create Lookup Table for CustAC Versions (was VERSIONS_TABLE)
            connection.prepareStatement(
            ...
            connection.prepareStatement(
                    "CREATE TABLE IF NOT EXISTS " + DatabaseConstants.VIOLATIONS_TABLE + "(" +
                            ...
                            DatabaseConstants.VIOLATIONS_GRIM_VERSION_ID_COLUMN + " INTEGER NOT NULL, " + // CustAC's version
            ...
            connection.prepareStatement(
                    "CREATE INDEX IF NOT EXISTS idx_" + DatabaseConstants.VIOLATIONS_TABLE + "_custac_version_id ON " + DatabaseConstants.VIOLATIONS_TABLE + "(" + DatabaseConstants.VIOLATIONS_GRIM_VERSION_ID_COLUMN + ")"
            ).execute();
            connection.prepareStatement(
    ...
    public synchronized void logAlert(CustACPlayer player, String custacVersion, String verbose, String checkName, int vls) {
        try (
            ...
            insertLog.setLong(7, custacVersionId);
        ...
        try (
                ...
                PreparedStatement fetchLogs = connection.prepareStatement(
                        "SELECT " +
                                ...
                                "gv." + DatabaseConstants.GRIM_VERSIONS_STRING_COLUMN + ", " + // Select CustAC's version string
