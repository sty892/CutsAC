...
import ac.cust.custac.manager.violationdatabase.*;
...
public class PostgresqlViolationDatabase implements ViolationDatabase {
    ...
    public void connect() throws SQLException {
        try (Connection connection = dataSource.getConnection()) {
            ...
            connection.prepareStatement(
                    "CREATE INDEX IF NOT EXISTS idx_" + DatabaseConstants.VIOLATIONS_TABLE + "_custac_version_id ON " + DatabaseConstants.VIOLATIONS_TABLE + "(" + DatabaseConstants.VIOLATIONS_GRIM_VERSION_ID_COLUMN + ");" // NEW
            ).execute();
            connection.prepareStatement(
