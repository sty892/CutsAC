...
public class PredictionEngineNormal extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(CustACPlayer player, Vector3dm vector) {
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, CustACPlayer player) {
        if (player.isClimbing) {
            ...
            vector.setX(CustACMath.clamp(vector.getX(), -0.15F, 0.15F));
            vector.setZ(CustACMath.clamp(vector.getZ(), -0.15F, 0.15F));
