...
public class PredictionEngineElytra extends PredictionEngine {
    public static Vector3dm getElytraMovement(CustACPlayer player, Vector3dm vector, Vector3dm lookVector) {
        float pitchRadians = CustACMath.radians(player.pitch);
        ...
        // Yeah, slow falling needs a refactor in custac.
