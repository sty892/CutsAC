...
public class PredictionEngineWater extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(CustACPlayer player, Vector3dm vector, float swimmingFriction, double playerGravity, boolean isFalling) {
    ...
    public static Set<VectorData> transformSwimmingVectors(CustACPlayer player, Set<VectorData> base) {
    ...
    public void guessBestMovement(float swimmingSpeed, CustACPlayer player, boolean isFalling, double playerGravity, float swimmingFriction) {
