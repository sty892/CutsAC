...
import ac.cust.custac.predictionengine.predictions.rideable.PredictionEngineNautilusWater;
...
public class MovementTickerNautilus extends MovementTickerLivingVehicle {
    ...
    public MovementTickerNautilus(CustACPlayer player) {
        super(player);
    ...
    public float getRiddenSpeed(CustACPlayer player) {
        PacketEntityNautilus nautilus = (PacketEntityNautilus) player.compensatedEntities.self.getRiding();
