...
import ac.cust.custac.utils.data.packetentity.JumpableEntity;
...
public final class PredictionEngineRideableUtils {
    ...
    public static Set<VectorData> handleJumps(CustACPlayer player, Set<VectorData> possibleVectors) {
    ...
    public static List<VectorData> applyInputsToVelocityPossibilities(Vector3dm movementVector, CustACPlayer player, Set<VectorData> possibleVectors, float speed) {
        return applyInputsToVelocityPossibilities(new PredictionEngine(), movementVector, player, possibleVectors, speed);
    }

    public static List<VectorData> applyInputsToVelocityPossibilities(PredictionEngine predictionEngine, Vector3dm movementVector, CustACPlayer player, Set<VectorData> possibleVectors, float speed) {
    ...
    public static void applyPendingJumps(CustACPlayer player) {
