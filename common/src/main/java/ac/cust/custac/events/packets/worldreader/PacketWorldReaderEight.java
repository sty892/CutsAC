...
public class PacketWorldReaderEight extends BasePacketWorldReader {
    @Override
    public void handleMapChunkBulk(final CustACPlayer player, final PacketSendEvent event) {
    ...
    @Override
    public void handleMapChunk(final CustACPlayer player, final PacketSendEvent event) {
        PacketWrapper<?> wrapper = new PacketWrapper<>(event);
