...
import ac.cust.custac.checks.impl.badpackets.BadPacketsW;
...
public class PacketPlayerAttack extends PacketListenerAbstract {
    ...
    private void onAttack(PacketReceiveEvent event, CustACPlayer player, int entityId) {
        if (isInvalidEntity(event, player, entityId)) return;
    ...
    private boolean isInvalidEntity(PacketReceiveEvent event, CustACPlayer player, int entityId) {
