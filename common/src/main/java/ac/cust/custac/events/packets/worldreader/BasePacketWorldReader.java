package ac.cust.custac.events.packets.worldreader;
...
public class BasePacketWorldReader extends PacketListenerAbstract {
    ...
    public void handleMapChunkBulk(CustACPlayer player, PacketSendEvent event) {
    ...
    public void handleMapChunk(CustACPlayer player, PacketSendEvent event) {
    ...
    public void addChunkToCache(PacketSendEvent event, CustACPlayer player, BaseChunk[] chunks, boolean isGroundUp, int chunkX, int chunkZ) {
    ...
    public void unloadChunk(CustACPlayer player, int x, int z) {
        if (player == null) return;
        player.compensatedWorld.removeChunkLater(x, z);
    }

    public void handleBlockChange(CustACPlayer player, PacketSendEvent event) {
    ...
    public void handleMultiBlockChange(CustACPlayer player, PacketSendEvent event) {
