...
import ac.cust.custac.utils.worldborder.BorderExtent;
import ac.cust.custac.utils.worldborder.RealTimeMovingBorderExtent;
import ac.cust.custac.utils.worldborder.StaticBorderExtent;
import ac.cust.custac.utils.worldborder.TickBasedMovingBorderExtent;
...
public class PacketWorldBorder extends Check implements PacketCheck {
    ...
    public PacketWorldBorder(CustACPlayer playerData) {
        super(playerData);
