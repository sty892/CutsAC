...
import ac.cust.custac.checks.impl.badpackets.BadPacketsE;
import ac.cust.custac.checks.impl.badpackets.BadPacketsF;
import ac.cust.custac.checks.impl.badpackets.BadPacketsG;
import ac.cust.custac.checks.impl.badpackets.BadPacketsH;
import ac.cust.custac.checks.impl.elytra.ElytraC;
...
public class PacketPlayerRespawn extends PacketListenerAbstract {
    ...
    public void onPacketSend(PacketSendEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.RESPAWN) {
            ...
            player.latencyUtils.addRealTimeTask(player.lastTransactionSent.get() + 1, () -> {
                ...
                if (!CustACAPI.INSTANCE.getSpectateManager().isSpectating(player.uuid)) {
    ...
    private boolean isWorldChange(CustACPlayer player, WrapperPlayServerRespawn respawn) {
