...
import static ac.cust.custac.utils.nmsutil.BlockBreakSpeed.getBlockDamage;
...
public class WrongBreak extends Check implements BlockBreakCheck {
    ...
    public WrongBreak(final CustACPlayer player) {
        super(player);
    }
    ...
    public void onBlockBreak(BlockBreak blockBreak) {
        ...
        if (blockBreak.action == DiggingAction.CANCELLED_DIGGING) {
            ...
            if (!shouldExempt(blockBreak.block, pos.y) && !pos.equals(lastBlock)) {
                // https://github.com/CustACAnticheat/CustAC/issues/1512
