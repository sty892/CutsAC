...
import ac.cust.custac.checks.debug.AbstractDebugHandler;
...
public class DebugHandler extends AbstractDebugHandler implements PostPredictionCheck {
    ...
    private final Set<CustACPlayer> listeners = new CopyOnWriteArraySet<>(new HashSet<>());
    ...
    public DebugHandler(CustACPlayer player) {
        super(player);
    }
    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        for (CustACPlayer listener : listeners) {
        ...
        if (outputToConsole) {
            Sender consoleSender = CustACAPI.INSTANCE.getPlatformServer().getConsoleSender();
    ...
    @Override
    public void toggleListener(CustACPlayer player) {
