...
public class BadPacketsT extends Check implements PacketCheck {
    ...
    public BadPacketsT(final CustACPlayer player) {
        super(player);
        // 1.7 and 1.8 seem to have different hitbox "expansion" values than 1.9+
        // https://github.com/CustACAnticheat/CustAC/pull/1274#issuecomment-1872458702
        // https://github.com/CustACAnticheat/CustAC/pull/1274#issuecomment-1872533497
