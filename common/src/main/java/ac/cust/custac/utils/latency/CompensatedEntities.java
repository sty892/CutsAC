...
import ac.cust.custac.utils.data.packetentity.dragon.PacketEntityEnderDragon;
import ac.cust.custac.utils.nmsutil.BoundingBoxSize;
import ac.cust.custac.utils.nmsutil.WatchableIndexUtil;
...
public class CompensatedEntities {
    ...
    public CompensatedEntities(CustACPlayer player) {
        this.player = player;
