...
public class Ray implements Cloneable {
    ...
    public Ray(CustACPlayer player, double x, double y, double z, float xRot, float yRot) {
    ...
    public static Vector3dm calculateDirection(CustACPlayer player, float xRot, float yRot) {
