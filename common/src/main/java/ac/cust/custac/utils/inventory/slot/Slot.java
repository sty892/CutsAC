...
public class Slot {
    ...
    public ItemStack safeTake(int p_150648_, int p_150649_, CustACPlayer p_150650_) {
    ...
    public Optional<ItemStack> tryRemove(int p_150642_, int p_150643_, CustACPlayer player) {
    ...
    // No override
    public boolean allowModification(CustACPlayer player) {
