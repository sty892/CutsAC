...
//        }
    ...
    public SimpleCollisionBox offset(double x, double y, double z) {
        ...
        switch (offsetType) {
            ...
            case XZ:
                l = CustACMath.hashCode(x, 0, z);
                offsetX = CustACMath.clamp(((double) ((float) (l & 15L) / 15.0F) - 0.5) * 0.5, -maxHorizontalModelOffset, maxHorizontalModelOffset);
                offsetZ = CustACMath.clamp(((double) ((float) (l >> 8 & 15L) / 15.0F) - 0.5) * 0.5, -maxHorizontalModelOffset, maxHorizontalModelOffset);
