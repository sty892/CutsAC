...
public class DynamicChorusPlant implements CollisionFactory {
    ...
    public CollisionBox getLegacyBoundingBox(CustACPlayer player, ClientVersion version, int x, int y, int z) {
    ...
    public Set<BlockFace> getLegacyStates(CustACPlayer player, ClientVersion version, int x, int y, int z) {
