...
import ac.cust.custac.utils.inventory.inventory.AbstractContainerMenu;
import ac.cust.custac.utils.inventory.slot.EquipmentSlot;
import ac.cust.custac.utils.inventory.slot.ResultSlot;
import ac.cust.custac.utils.inventory.slot.Slot;
import ac.cust.custac.utils.lists.CorrectingPlayerInventoryStorage;
...
public class Inventory extends AbstractContainerMenu {
    ...
    public Inventory(CustACPlayer player, CorrectingPlayerInventoryStorage inventoryStorage) {
        super(player);
