package ac.cust.custac.utils.collisions;

import ac.cust.custac.player.CustACPlayer;
import ac.cust.custac.predictionengine.movementtick.MovementTickerStrider;
import ac.cust.custac.utils.collisions.blocks.DoorHandler;
import ac.cust.custac.utils.collisions.blocks.DynamicChest;
import ac.cust.custac.utils.collisions.blocks.DynamicChorusPlant;
import ac.cust.custac.utils.collisions.blocks.DynamicStair;
import ac.cust.custac.utils.collisions.blocks.PistonBaseCollision;
import ac.cust.custac.utils.collisions.blocks.PistonHeadCollision;
import ac.cust.custac.utils.collisions.blocks.TrapDoorHandler;
import ac.cust.custac.utils.collisions.blocks.connecting.DynamicCollisionFence;
import ac.cust.custac.utils.collisions.blocks.connecting.DynamicCollisionPane;
import ac.cust.custac.utils.collisions.blocks.connecting.DynamicCollisionWall;
...
import ac.cust.custac.utils.collisions.datatypes.ComplexCollisionBox;
import ac.cust.custac.utils.collisions.datatypes.DynamicCollisionBox;
import ac.cust.custac.utils.collisions.datatypes.HexCollisionBox;
import ac.cust.custac.utils.collisions.datatypes.HexOffsetCollisionBox;
...
public enum CollisionData implements CollisionFactory {
    ...
    public CollisionBox getMovementCollisionBox(CustACPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
        return fetch(player, version, block, x, y, z).offset(x, y, z);
    }

    public CollisionBox getMovementCollisionBox(CustACPlayer player, ClientVersion version, WrappedBlockState block) {
        if (this.box != null)
