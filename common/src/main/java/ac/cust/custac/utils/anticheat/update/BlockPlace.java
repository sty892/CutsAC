...
import ac.cust.custac.utils.collisions.AxisSelect;
...
public class BlockPlace {
    ...
    public BlockPlace(CustACPlayer player, InteractionHand hand, Vector3i position, int faceId, BlockFace face, ItemStack itemStack, @Nullable HitData hitData, int sequence) {
        this.player = player;
        this.hand = hand;
    ...
    public BlockFace getPlayerFacing() {
        return BY_2D[CustACMath.floor(player.yaw / 90.0D + 0.5D) & 3];
    }
