...
public enum MenuType {
    ...
    public static AbstractContainerMenu getMenuFromID(CustACPlayer player, Inventory playerInventory, MenuType type) {
        return switch (type) {
    ...
    public static AbstractContainerMenu getMenuFromString(CustACPlayer player, Inventory inventory, String legacyType, int slots, int horse) {
