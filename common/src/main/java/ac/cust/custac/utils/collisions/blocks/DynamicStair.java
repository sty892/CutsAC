...
public class DynamicStair implements CollisionFactory {
    ...
    public static EnumShape getStairsShape(CustACPlayer player, WrappedBlockState originalStairs, int x, int y, int z) {
    ...
    private static boolean canTakeShape(CustACPlayer player, WrappedBlockState stairOne, int x, int y, int z) {
