...
public class GetBoundingBox {
    public static SimpleCollisionBox getCollisionBoxForPlayer(@NotNull CustACPlayer player, double centerX, double centerY, double centerZ) {
        if (player.inVehicle()) {
    ...
    public static @NotNull SimpleCollisionBox getPacketEntityBoundingBox(CustACPlayer player, double centerX, double minY, double centerZ, PacketEntity entity) {
    ...
    public static @NotNull SimpleCollisionBox getPlayerBoundingBox(@NotNull CustACPlayer player, double centerX, double minY, double centerZ) {
    ...
    public static @NotNull SimpleCollisionBox getBoundingBoxFromPosAndSize(@NotNull CustACPlayer player, double centerX, double minY, double centerZ, float width, float height) {
    ...
    public static double @NotNull [] getEntityDimensions(CustACPlayer player, @NotNull PacketEntity entity) {
        final float scale = (float) entity.getAttributeValue(Attributes.SCALE);
    ...
    public static void expandBoundingBoxByEntityDimensions(@NotNull SimpleCollisionBox box, CustACPlayer player, PacketEntity entity) {
