...
import ac.cust.custac.utils.collisions.AxisUtil;
...
public class ConsumesBlockPlace {
    public static boolean consumesPlace(@NotNull CustACPlayer player, @NotNull WrappedBlockState state, @NotNull BlockPlace place) {
