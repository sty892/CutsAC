...
public class PacketEntityHorse extends PacketEntityTrackXRot implements JumpableEntity {
    ...
    public PacketEntityHorse(CustACPlayer player, UUID uuid, EntityType type, double x, double y, double z, float xRot) {
    ...
    @Override
    public boolean canPlayerJump(CustACPlayer player) {
        return this.hasSaddle();
    }

    @Override
    public void executeJump(CustACPlayer player, Set<VectorData> possibleVectors) {
