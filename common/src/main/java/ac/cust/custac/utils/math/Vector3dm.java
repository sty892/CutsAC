package ac.cust.custac.utils.math;
...
public class Vector3dm implements Cloneable, Serializable {
    ...
    public double length() {
        return Math.sqrt(CustACMath.square(this.x) + CustACMath.square(this.y) + CustACMath.square(this.z));
    }

    public double lengthSquared() {
        return CustACMath.square(this.x) + CustACMath.square(this.y) + CustACMath.square(this.z);
    }
    ...
    public double distanceSquared(double oX, double oY, double oZ) {
        return CustACMath.square(this.x - oX) + CustACMath.square(this.y - oY) + CustACMath.square(this.z - oZ);
    }
    ...
    public boolean isInSphere(@NotNull Vector3dm origin, double radius) {
        return CustACMath.square(origin.x - this.x) + CustACMath.square(origin.y - this.y) + CustACMath.square(origin.z - this.z) <= CustACMath.square(radius);
    }
    ...
    public int getBlockX() {
        return CustACMath.mojangFloor(this.x);
    }
    ...
    public int getBlockY() {
        return CustACMath.mojangFloor(this.y);
    }
    ...
    public int getBlockZ() {
        return CustACMath.mojangFloor(this.z);
    }
