...
public class DynamicHitboxWall extends DynamicConnecting implements HitBoxFactory {
    @Override
    public CollisionBox fetch(CustACPlayer player, StateType heldItem, ClientVersion version, WrappedBlockState state, boolean isTargetBlock, int x, int y, int z) {
    ...
    private int[] getConnections(CustACPlayer player, ClientVersion version, WrappedBlockState state, int x, int y, int z) {
