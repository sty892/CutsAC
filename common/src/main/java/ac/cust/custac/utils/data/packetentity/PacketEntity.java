// This file was designed and is an original check for CustACAC
...
import ac.cust.custac.utils.data.ReachInterpolationData;
import ac.cust.custac.utils.data.TrackedPosition;
...
public class PacketEntity extends TypedPacketEntity {
    ...
    public PacketEntity(CustACPlayer player, EntityType type) {
        super(type);
        this.uuid = null;
    ...
    public PacketEntity(CustACPlayer player, UUID uuid, EntityType type, double x, double y, double z) {
        super(type);
        this.uuid = uuid;
        initAttributes(player);
        this.trackedServerPosition = new TrackedPosition();
    ...
    protected void initAttributes(CustACPlayer player) {
    ...
    public void onFirstTransaction(boolean relative, boolean hasPos, double relX, double relY, double relZ, CustACPlayer player) {
        if (hasPos) {
            if (relative) {
    ...
    public void setPositionRaw(CustACPlayer player, SimpleCollisionBox box) {
