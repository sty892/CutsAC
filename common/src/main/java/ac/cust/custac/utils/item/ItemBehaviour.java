...
public class ItemBehaviour {
    ...
    protected boolean testConsumableComponent(ItemStack item, CompensatedWorld world, CustACPlayer player, InteractionHand hand, ItemConsumable consumable) {
    ...
    protected boolean testFoodComponent(ItemStack item, CompensatedWorld world, CustACPlayer player, InteractionHand hand) {
