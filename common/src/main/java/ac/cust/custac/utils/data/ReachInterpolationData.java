// This file was designed and is an original check for CustACBukkitLoaderPlugin
...
public class ReachInterpolationData {
    ...
    public ReachInterpolationData(CustACPlayer player, SimpleCollisionBox startingLocation, TrackedPosition position, PacketEntity entity) {
    ...
    public ReachInterpolationData(CustACPlayer player, SimpleCollisionBox finishedLoc, PacketEntity entity) {
...
//        int interpolationStepsLowBound = Math.min(this.interpolationStepsLowBound, this.cancelledLerpInterpolationStepsLowBound); // Temp test
    ...
    public void updatePossibleStartingLocation(SimpleCollisionBox possibleLocationCombined) {
        //CustACBukkitLoaderPlugin.LOADER.getBukkitSenderFactory(). reverse(sender);
